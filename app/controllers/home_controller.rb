class HomeController < ApplicationController
  ...
  def set_note
    ...
    if NEW_SCHEDULES_LIVE && !is_january_or_feb?
      ...
      @note += " New schedules will be posted after the City publishes them (typically in late March), at which point all alert subscriptions that are either unconfirmed or without street addresses will be deleted."
    end
  end
