class HomeController < ApplicationController
  ...
  def set_note
    ...
    if NEW_SCHEDULES_LIVE && !is_january_thru_march?
      ...
      @note += " New schedules will be posted after the City publishes them (typically in late March / early April), at which point all alert subscriptions that are either unconfirmed or without street addresses will be deleted."
    end
  end
