class HomeController < ApplicationController
  ...
  def set_note
    ...
    if NEW_SCHEDULES_LIVE && !is_beginning_of_year?
      @note += ' If your street address has changed, simply subscribe with your new address and then remove the old one from your <a href="/subscriptions" class="underline font-medium">Manage Subscriptions</a> page.'
